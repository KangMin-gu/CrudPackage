...
public class CompanyController {
	...
	// READ
	@RequestMapping(value="/company/{siteId}",method=RequestMethod.GET)
	...
	// UPDATE 화면
	@RequestMapping(value="/company/post/{siteId}",method=RequestMethod.GET)
	...
	//UPDATE 실행
	@RequestMapping(value="/company/post/{siteId}",method=RequestMethod.PUT)
	public ModelAndView authCompanyUpdateSet(@ModelAttribute CompanyDto CompanyDto,HttpServletRequest request) {
		...
		mView.setViewName("redirect:/company/"+siteId);
		return mView;
	}
	// INSERT 화면
	@RequestMapping(value="/company/post", method=RequestMethod.GET)
	...
	@RequestMapping(value="/company/{siteId}", method=RequestMethod.POST)
	public ModelAndView authCompanyDelete(@PathVariable int siteId,HttpServletRequest request) {
		...
		mView.setViewName("redirect:/company");
		return mView;
	}
	// LIST에서 멀티 삭제
	...
	@RequestMapping(value="company/license/{siteid}", method=RequestMethod.POST)
