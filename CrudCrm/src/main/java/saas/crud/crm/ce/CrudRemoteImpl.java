...
@Service
public class CrudRemoteImpl implements CrudRemote {
	...
	public Map<String,Object> getRemote(HttpServletRequest request) {
		...
		userRemote.put("userip", ip);
		userRemote.put("userbrowser", browser);
		userRemote.put("userdevice", device);
		userRemote.put("useros", os);
