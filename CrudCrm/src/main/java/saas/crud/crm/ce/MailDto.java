...
public class MailDto {
	...
	public MailDto(int emaillogid, int siteid, String cstname, String username, String fromemail, String toemail,
			String subject, String content, int filesearchkey, String rltdate, int clickyn, int linkyn, int reserv,
			int emailtype, int rltcode) {
		super();
