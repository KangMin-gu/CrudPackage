                        ...
                        <div class="ibox-content row">
                        	<div class="box col-12" style="padding-left: 0px;padding-right: 0px;">
                            	...
                            	<div class="w-100 text-right mb-2">
                                	<a href="${pageContext.request.contextPath}/ad/user" class="btn btn-primary">취소</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" class="form-control col-3 float-left mr-2 validate phone2" name="mobile2" id="mobile2" value="${user.MOBILE2 }">
                                                <input type="text" class="form-control col-3 float-left validate phone3" name="mobile3" id="mobile3" value="${user.MOBILE3 }">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" class="form-control col-3 float-left mr-2 validate phone2" name="telno2" id="telno2" value="${user.TELNO2 }">
                                                <input type="text" class="form-control col-3 float-left validate phone3" name="telno3" id="telno3" value="${user.TELNO3 }">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="password" class="form-control error required name"  name="userpassword" id="userpassword" value="${user.USERPASSWORD}"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control float-left error required phone1" name="chkauth" id="chkauth">
                                                	<option>선택</option>
