...
<!-- Content -->		
<form:form action ="${pageContext.request.contextPath}/au/post/${user.USERNO }" method="PUT">
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control float-left mr-3" name="chkrole" id="chkrole" >
                                                    <option value=02 <c:if test='${user.CHKROLE eq 02}'>selected</c:if>>02</option>
                                                    <option value=031 <c:if test='${user.CHKROLE eq 031}'>selected</c:if>>031</option>
                                                    <option value=032 <c:if test='${user.CHKROLE eq 032}'>selected</c:if>>032</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control float-left required" name="isdelete" id="isdelete">
                                                	<option>선택</option>
                                                    <option value=0 <c:if test='${user.ISDELETE eq 0}'>selected</c:if>>사용</option>
                                                    <option value=1 <c:if test='${user.ISDELETE eq 1}'>selected</c:if>>미사용</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody>
...
<!-- js includ -->
	...
	$('.save').click(function(e){
		...
		if(checkval == 0){
			e.preventDefault();
			alert("중복되는 ID 입니다. ID를 다시 입력해주세요");
		}
	});
