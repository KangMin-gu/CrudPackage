								...
								<div class="ibox-content row">													
									<div class="col-md-8 offset-md-2">
										<div class="row">
											...
											<div class="col-xl-10"><input style="height:30px;" id="title" name="title" type="text" class="form-control" value=""></div>
										</div>										
									</div>																							                        		                            	           
								</div>								
								...
								<div class="row">
									<div class="col-md-8 offset-md-2">										 		
										<c:if test="${CHKAUTH eq 20 || CHKAUTH eq 30 }">													
											<a href="${pageContext.request.contextPath}/ad/user/post" class="btn btn-primary float-right">취소</a>
											<a href="${pageContext.request.contextPath}/ad/user/post" class="btn btn-primary float-right" style="margin-right:3px;">등록</a>																		
										</c:if>																																																			
									</div>	
								</div>
								</form:form>
