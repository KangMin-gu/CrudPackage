                    ...
                    <form:form action="${pageContext.request.contextPath}/campaign" method="POST">
                        ...
                        <div class="ibox-content row border-top-0 pt-lg-0 tooltip-demo">
                            ...
                            <table class="table table-bordered" style="border-top: 1px solid #e7eaec;">
                                ...
                                <tbody>
                                    <c:forEach var="tabCust" items="${tabCust }">
                                    	<tr>
                                        	<td><input type="checkbox" class="i-checks" name="custno" id="custno" value="${tabCust.CUSTNO }"></td>
                                        	<td>${tabCust.CUSTNAME }</td>
                                        	<td>${tabCust.CUSTID }</td>
                                        	<td>${tabCust.MOBILENO }</td>
                                        	<td>${tabCust.EMAIL }</td>
                                        	<td>${tabCust.INFOAGREE_ }</td>
                                        	<td>${tabCust.CUSTGUBUN_ }</td>
                                        	<td>${tabCust.CUSTGRADE_ }</td>
                                        	<td>${tabCust.ADDR_ }</td>
                                    	</tr>
                                	</c:forEach>
                                </tbody>
