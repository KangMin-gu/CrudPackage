				...
				<div class="row">
					...
					<div class="col-lg-10 animated fadeInRight">
						<div class="mail-box-header">				
							<form:form method="post" action="${pageContext.request.contextPath}/note/import">
									<div class="container-fluid">
										<div class="row">
											<div class="col-lg-3 "><h2>중요 통지 (${notReadVal })</h2></div> 
											<div class="col-lg-9 ">										
												<div class="container">
													<div class="row">
														<div class="col-lg-6">																													
							...
							<div class="mail-tools tooltip-demo m-t-md">
									...
									<ul class="pagination">
										<c:choose>
											<c:when test="${page.startPageNum ne 1 }">
												<li><a
													href="${pageContext.request.contextPath}/note/import?pageNum=${page.startPageNum-1 }&condition=${condition}&keyword=${keyword}&startdate=${startdate}&enddate=${enddate}">&laquo;</a>
												</li>
											</c:when>
											<c:otherwise>
											...
											<c:choose>
												<c:when test="${i eq page.pageNum }">
													<li class="active page-item"><a class="page-link"
														href="${pageContext.request.contextPath}/note/import?pageNum=${i }&condition=${condition}&keyword=${keyword}&startdate=${startdate}&enddate=${enddate}">${i }</a></li>
												</c:when>
												<c:otherwise>
													<li><a
														href="${pageContext.request.contextPath}/note/import?pageNum=${i }&condition=${condition}&keyword=${keyword}&startdate=${startdate}&enddate=${enddate}">${i }</a></li>
										...
										<c:choose>
											<c:when test="${page.endPageNum lt page.totalPageCount }">
												<li><a
													href="${pageContext.request.contextPath}/note/import?pageNum=${page.endPageNum+1 }&condition=${condition}&keyword=${keyword}&startdate=${startdate}&enddate=${enddate}">&raquo;</a>
												</li>
											</c:when>
											<c:otherwise>
								...
								<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" title="새로고침" 
									onclick="window.location.href='${pageContext.request.contextPath}/note/import?pageNum=${page.pageNum}&condition=${condition}&keyword=${keyword}&startdate=${startdate}&enddate=${enddate}'">
