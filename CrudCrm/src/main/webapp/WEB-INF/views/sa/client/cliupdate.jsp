		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="/sales/client/view/${cliUpdate.CLINO }">상세정보</a></li>
			...
			<div class="wrapper wrapper-content  animated fadeInRight article">
				<form:form id="command"
					action="/sales/client/post/${cliUpdate.CLINO }" method="POST">
									...
									<div class="box col-12" style="padding-left: 0px;padding-right: 0px;">
										<div class="col-xl-8 col-lg-12 float-left alert alert-info w-100" id="reqMsgDiv" style="height:2.00rem;padding-top: 6px;overflow:hidden;display:none;" >
											<span id="reqDefaultMsg" title="필수 입력값을 확인해 주세요.&nbsp;&nbsp;(거래처명,거래처호칭 : 한글,영문,숫자,기호) ">
												<strong>필수 입력값을 확인해 주세요.&nbsp;&nbsp;(거래처명,거래처호칭 : 한글,영문,숫자,기호) </strong>
											</span>
										...
										<div class="w-100 text-right mb-3 mt-3">
											...
											<a href="/sales/client/view/${cliUpdate.CLINO }" class="btn btn-primary">상세</a> 
												...
												<tr>
													...
													<td class="border-top-0">
														<div class="input-group col-lg-3 pl-0 float-left">
															<input type="text" class="form-control daumzip" name="cliaddr1" id="cliaddr1" value="${cliUpdate.CLIADDR1 }" readonly> 
										...
										<table class="table table-bordered mb-0 border-top-0">
											...
											<tbody>
												<tr>
													...
													<td class="border-top-0">
														<textarea name="memo" id="memo" class="form-control" style="resize: none; height: 8em;">${cliUpdate.MEMO }</textarea>
													</td>
												</tr>
											</tbody>
										</table>
