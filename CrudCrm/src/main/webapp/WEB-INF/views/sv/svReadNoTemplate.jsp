								...
								<table class="table table-bordered border-top-0 mb-0">
									...
									<tbody>
										<tr>
											...
											<td class="border-top-0">${serviceInfo.SERVICENAME }</td>
										</tr>
								...
								<table class="table table-bordered border-top-0 mb-0">
									...
									<tbody>
										<tr>
											...
											<td class="border-top-0">${serviceInfo.OWNER_ }</td>
										</tr>
									</tbody>
								</table>
							</div>
												...
												<div class="select-area mt-1">
													<c:forEach var="product" items="${product }">
														<div class="select-box mb-1 product" style="height: 29px;">
															<select id="product11" disabled name="product11"
																class="form-control col-xl-3 d-inline-block mr-2 voc">
																<option label="${product.PRODUCTBNAME }"
																	value="${product.PRODUCTBNAME }" />
															</select> <select id="product11" disabled name="product11"
																class="form-control col-xl-3 d-inline-block mr-2 voc">
																<option label="${product.PRODUCTMNAME }"
																	value="${product.PRODUCTMNAME }" />
															</select> <select id="product11" disabled name="product11"
																class="form-control col-xl-3 d-inline-block mr-2 voc">
																<option label="${product.PRODUCTSNAME }"
								...
								<div class="attachment">
									<c:forEach var="serviceFile" items="${serviceFile }">
										<div class="file-box">
											<div class="file">
												<a
													href="${pageContext.request.contextPath}/campaign/download/${serviceFile.FILEID}">
								...
								<table class="table table-bordered mb-0">
									...
									<tbody>
										<tr>
											...
											<td style="height: 58px;">${rewardInfo.DELAYTYPE_ }</td>
										</tr>
									</tbody>
								</table>
							</div>
									...
									<tbody>
										<tr>
											...
											<td><textarea class="form-control" disabled
													id="delaydesc" cols="80">${rewardInfo.DELAYDESC }</textarea>
											</td>
										</tr>
									</tbody>
								</table>
								...
								<div class="attachment">
									<c:forEach var="rewardFile" items="${rewardFile }">
										<div class="file-box">
											<div class="file">
												<a
													href="${pageContext.request.contextPath}/campaign/download/${rewardFile.FILEID}">
													<span class="corner"></span>
													<div class="icon">
														<i class="fa fa-file"></i>
													</div>
								...
								<div class="attachment">
									<c:forEach var="ractFile" items="${ractFile }">
										<div class="file-box">
											<div class="file">
												<a
													href="${pageContext.request.contextPath}/campaign/download/${ractFile.FILEID}">
													<span class="corner"></span>
													<div class="icon">
														<i class="fa fa-file"></i>
													</div>
							...
							<div class="box1 col-lg-12 p-0">
								<div class="tabs-container">
									<ul class="nav nav-tabs" role="tablist">
										<li><a class="nav-link li tabRact active"
											data-toggle="tab" href="#tab1">처리 이력</a></li>
										<li><a class="nav-link tabConvey" data-toggle="tab"
											href="#tab2">이관이력</a></li>
									</ul>
