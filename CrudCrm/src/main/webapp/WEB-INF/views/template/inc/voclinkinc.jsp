<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <link href="${pageContext.request.contextPath}/resources/css/vocstyle.css" rel="stylesheet">
    ...
    <link href="${pageContext.request.contextPath}/resources/css/newVoc.css" rel="stylesheet"> <!--datePicker-->
    <!-- E: 추가 CSS-->