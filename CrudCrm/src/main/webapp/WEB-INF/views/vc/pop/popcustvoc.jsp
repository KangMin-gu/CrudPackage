		...
		<div class="wrapper wrapper-content  animated fadeInRight article">
			...
			<div class="col-lg-12">
				...
				<div class="ibox-content row border-top-0 ">						
					...
					<div class="col-mg-12 p-0 float-left" style="margin-bottom: 10px;">
...
function vocGetCustInfo(urlStr){//고객정보 획득 후 바인딩 하는 매서드
	$.ajax({
        url: urlStr,
        method: "GET",
        dataType: "json",
...
function custInfoBinding(data){
	...
	opener.$('#relcustname').val(data.RELCUSTNAME);
 ...
 */
function custFormActivation(statusStr){
	debugger;
